    ...
    <div class="card shadow-lg ">
      <div class="card-header pb-0 pt-3 ">
        <div class="{{ (Request::is('rtl') ? 'float-end' : 'float-start') }}">
          <h5 class="mt-3 mb-0">UN_FST_DMI</h5>
          <p>disine</p>
        </div>
      ...
      <div class="card-body pt-sm-3 pt-0">
        ...
        <a class="btn bg-gradient-dark w-100" href="http://resultats.una.mr/FST/" target="_blank">Resulta</a>
        <a class="btn btn-outline-dark w-100" href="https://rim-un.free.nf/pages/list_note.php" target="_blank">Autre Resulta</a>
        <div class="w-100 text-center">
          <a class="github-button" href="https://github.com/Ahmedouyahya/" target="_blank" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="GitHub">Star</a>
          <h6 class="mt-3">Ahmedouyahya!</h6>
